    ...
    public partial class AddTaskRuntimeScopeLifecycle : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                FROM [tasks].[task_control_messages] AS message
                INNER JOIN [tasks].[task_runs] AS run
                    ON run.[Id] = message.[RunId];
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, collation: "Latin1_General_100_BIN2"),
